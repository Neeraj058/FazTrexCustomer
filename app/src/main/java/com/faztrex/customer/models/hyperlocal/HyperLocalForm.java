...
public class HyperLocalForm implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(AddressTypeName);
        parcel.writeString(PickupPostcode);
        parcel.writeString(PickupAddress1);
        parcel.writeString(PickupAddress2);
        parcel.writeString(PickupPersonName);
        parcel.writeString(PickupContactNo);
        parcel.writeString(DeliveryPostcode);
        parcel.writeString(DeliveryAddress1);
        parcel.writeString(DeliveryAddress2);
        parcel.writeString(DeliveryPersonName);
        parcel.writeString(DeliveryContactNo);
        if (IsDocument == null) {
            parcel.writeByte((byte) 0);
        } else {
            parcel.writeByte((byte) 1);
            parcel.writeInt(IsDocument);
        }
        if (IsElectronic == null) {
            parcel.writeByte((byte) 0);
        } else {
            parcel.writeByte((byte) 1);
            parcel.writeInt(IsElectronic);
        }
        if (IsEssential == null) {
            parcel.writeByte((byte) 0);
        } else {
            parcel.writeByte((byte) 1);
            parcel.writeInt(IsEssential);
        }
        if (IsMedicine == null) {
            parcel.writeByte((byte) 0);
        } else {
            parcel.writeByte((byte) 1);
            parcel.writeInt(IsMedicine);
        }
        if (IsOthers == null) {
            parcel.writeByte((byte) 0);
        } else {
            parcel.writeByte((byte) 1);
            parcel.writeInt(IsOthers);
        }
        if (WeightTypeId == null) {
            parcel.writeByte((byte) 0);
        } else {
            parcel.writeByte((byte) 1);
            parcel.writeInt(WeightTypeId);
        }
        parcel.writeString(WeightTypeName);
        parcel.writeString(SpecialInstruction);
        if (DistancePaymentTypeId == null) {
            parcel.writeByte((byte) 0);
        } else {
            parcel.writeByte((byte) 1);
            parcel.writeInt(DistancePaymentTypeId);
        }
