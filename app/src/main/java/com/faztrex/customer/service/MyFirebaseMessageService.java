package com.faztrex.customer.service;
...
import com.faztrex.customer.helper.OreoNotification;
...
public class MyFirebaseMessageService extends FirebaseMessagingService {
    ...
    public void onNewToken(@NonNull String token) {
        ...
        AppPreference appPreference = AppPreference.getInstance(getApplicationContext(), AppConstants.PREFERENCE_FILE_NAME);
